...
import { Home, Calculator, ClipboardList, AlertTriangle, Menu, X, DollarSign, MapPin, BookOpen, MessageSquare } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { path: '/negotiation', label: 'AI Negotiation', icon: MessageSquare },
